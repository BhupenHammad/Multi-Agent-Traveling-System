...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio",
            "command": r"D:\multi-agent-system\aviationstack-mcp\.venv\Scripts\python.exe",
            "args": [
                "-m",
                "aviationstack_mcp",
                "mcp",
        ...
        "weather": {
            "transport": "stdio",
            "command": r"D:\multi-agent-system\myenv\Scripts\python.exe",
            "args": [
                r"D:\multi-agent-system\create _custom_mcp.py"
            ],
            "env": {
